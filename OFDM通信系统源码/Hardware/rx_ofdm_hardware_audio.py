...
# Generated: Mon May 23 15:08:18 2022
##################################################
...
class rx_ofdm_hardware_audio(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "rx_ofdm_hardware_audio")
        ...
        self.osmosdr_source_0.set_center_freq(118e6, 0)
        ...
        self.blocks_wavfile_sink_0 = blocks.wavfile_sink('/home/lyj/\xe6\xa1\x8c\xe9\x9d\xa2/\xe6\x9c\x80\xe6\x96\xb0\xe7\xa1\xac\xe4\xbb\xb6\xe6\xb5\x8b\xe8\xaf\x95/receive_\xe9\x9b\xaa\xe5\xb1\xb1_64fft_96byte.wav', 1, 44100, 8)
        ...
        self.connect((self.digital_crc32_bb_0, 0), (self.vocoder_cvsd_decode_bf_0_0, 0))
...
def main(top_block_cls=rx_ofdm_hardware_audio, options=None):
