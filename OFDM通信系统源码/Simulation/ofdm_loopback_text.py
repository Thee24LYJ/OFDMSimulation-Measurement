...
class ofdm_loopback_text(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "OFDM Loopback Text")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("OFDM Loopback Text")
        ...
        self.settings = Qt.QSettings("GNU Radio", "ofdm_loopback_text")
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/lyj/\xe6\xa1\x8c\xe9\x9d\xa2/OFDM\xe7\xb3\xbb\xe7\xbb\x9f/send.txt', True)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/lyj/\xe6\xa1\x8c\xe9\x9d\xa2/OFDM\xe7\xb3\xbb\xe7\xbb\x9f/receive.txt', False)
        ...
        self.connect((self.blocks_throttle_0, 0), (self.qtgui_time_sink_x_1_0_0_0_0, 0))
...
def main(top_block_cls=ofdm_loopback_text, options=None):
