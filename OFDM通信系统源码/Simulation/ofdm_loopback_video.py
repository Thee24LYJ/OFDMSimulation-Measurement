...
class ofdm_loopback_video(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "OFDM Loopback Video")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("OFDM Loopback Video")
        ...
        self.settings = Qt.QSettings("GNU Radio", "ofdm_loopback_video")
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/lyj/\xe8\xa7\x86\xe9\xa2\x91/video.mp4', False)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/lyj/\xe6\xa1\x8c\xe9\x9d\xa2/receive_video.mp4', False)
        ...
        self.connect((self.blocks_uchar_to_float_0, 0), (self.qtgui_freq_sink_x_0_1, 0))
...
def main(top_block_cls=ofdm_loopback_video, options=None):
