...
class ofdm_loopback_picture(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "OFDM Loopback Picture")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("OFDM Loopback Picture")
        ...
        self.settings = Qt.QSettings("GNU Radio", "ofdm_loopback_picture")
        ...
        self.qtgui_freq_sink_x_0_1_1.enable_autoscale(True)
        ...
        self.blocks_file_source_0_0 = blocks.file_source(gr.sizeof_char*1, '/home/lyj/\xe5\x9b\xbe\xe7\x89\x87/lena.jpg', False)
        self.blocks_file_sink_1 = blocks.file_sink(gr.sizeof_char*1, '/home/lyj/\xe6\xa1\x8c\xe9\x9d\xa2/receive_lena.jpg', True)
        ...
        self.connect((self.blocks_file_source_0_0, 0), (self.blocks_uchar_to_float_1, 0))
        self.connect((self.blocks_stream_to_tagged_stream_0, 0), (self.digital_ofdm_tx_0, 0))
        self.connect((self.blocks_throttle_0_0, 0), (self.digital_ofdm_rx_0, 0))
        self.connect((self.blocks_throttle_0_0, 0), (self.qtgui_freq_sink_x_0_1, 0))
        self.connect((self.blocks_uchar_to_float_0_0, 0), (self.qtgui_freq_sink_x_0_0, 0))
        self.connect((self.blocks_uchar_to_float_1, 0), (self.qtgui_freq_sink_x_0_1_1, 0))
        self.connect((self.blocks_uchar_to_float_1, 0), (self.qtgui_time_sink_x_1_0_0, 0))
        ...
        self.connect((self.digital_ofdm_rx_0, 0), (self.blocks_uchar_to_float_0_0, 0))
        self.connect((self.digital_ofdm_tx_0, 0), (self.channels_channel_model_0_0, 0))
        self.connect((self.digital_ofdm_tx_0, 0), (self.qtgui_freq_sink_x_0_1_0, 0))
    ...
    def set_noise_voltage(self, noise_voltage):
        ...
        self.channels_channel_model_0_0.set_noise_voltage(self.noise_voltage)
    ...
    def set_freq_offset(self, freq_offset):
        ...
        self.channels_channel_model_0_0.set_frequency_offset(self.freq_offset * 1.0/self.fft_len)
...
def main(top_block_cls=ofdm_loopback_picture, options=None):
